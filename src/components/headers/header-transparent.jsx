                    ...
                    <div className="header-left d-flex align-items-center">
                        ...
                        <nav className="mainmenunav d-lg-block ml--50">
                            <ul className="mainmenu">
                                <li className="has-droupdown" onclick={handleClick}><Link href="#">Home</Link>
                                ...
                                <li className="has-droupdown" onclick={handleClick}><Link href="/service" >Service</Link>
                                    <ul className="submenu">
                                ...
                                <li className="has-droupdown" onclick={handleClick}><Link href="#pages" >Pages</Link>
                                    <ul className="submenu">
                                ...
                                <li className="has-droupdown" onclick={handleClick}><Link href="#" >Blocks</Link>
                                    <ul className="submenu">
                                        <li><Link href="/portfolio">Portfolio</Link></li>
